...
//	},
	...
	onSearchProduct:function(oEvt){
		...
		if(sProduct !== undefined || sProduct !== ""){
			...
			var sUrl = "https://services.odata.org/V3/OData/OData.svc/Products?$filter=substringof('"+sProduct+"', Name) eq true&$format=json";
	...
	onProductListPress : function(oEvt){
		...
		var sUrl = "https://services.odata.org/V3/OData/OData.svc/Products?$filter=substringof('"+sProductPress+"', Name) eq true&$format=json";
